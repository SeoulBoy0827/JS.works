...
var app = http.createServer(function(req,res){
    ...
    var queryData = new URL(req.url, baseURL).searchParams;
    var title = queryData.get('id');
    var pathname = new URL(req.url, baseURL).pathname;
    if(pathname === '/'){
        ...
        fs.readFile(`data/${queryData.get('id')}`, 'utf8', function(err, text){
            var template = `
            <!doctype html>
            <html>
            <head>
